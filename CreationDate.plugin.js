/**
 * @name CreationDate
 * @authorId 747445077885845515
 * @invite KreUafv
 * @website https://github.com/13MrBlackCat13/CreationDate
 * @source https://github.com/13MrBlackCat13/CreationDate
 */
		...
		return class CreationDate extends Plugin {
			...
			getSettingsPanel (collapseStates = {}) {
				...
				settingsItems.push(BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.CollapseContainer, {
					...
					collapseStates: collapseStates,
					children: [
						"$hour будет заменен часом даты",
						"$minute будет заменена на минуты даты",
						"$second будет заменена на секунды даты",
						"$msecond будет заменен на миллисекунды даты",
						"$timemode изменит $ час на 12-часовой формат и будет заменен на AM / PM",
						"$year будет заменен годом даты",
						"$yearS будет заменен годом в краткой форме",
						"$month будет заменен месяцем числа",
						"$day будет заменен на день даты",
						"$monthnameL будет заменено названием месяца в длинном формате на основе языка Discord",
						"$monthnameS будет заменено названием месяца в кратком формате на основе языка Discord",
						"$weekdayL будет заменен на день недели в длинном формате на основе языка Discord",
						"$weekdayS будет заменен на день недели в сокращенном формате на основе языка Discord",
						"$daysago будет заменен строкой, чтобы сообщить вам, сколько дней назад произошло событие. Например: " + BDFDB.LanguageUtils.LanguageStringsFormat("ACTIVITY_FEED_USER_PLAYED_DAYS_AGO", 3)
